...
const Devs = () => {
  ...
  useEffect(() => {
    var userArr = [
      [1500, "img-15.jpg", "-2170px", 0],
      [1004, "img-14.jpg", "-350px", 1],
      [753, "img-13.jpg", "-800px", 2],
      [502, "img-12.png", "-1250px", 3],
      [251, "img-11.jpg", "-1700px", 4],
      [0, "img-10.jpg", "100px", 5],
    ];
    userArr.reverse();
    showSlides();
    ...
    function showSlides() {
      ...
      handleClick(
        userArr[slideIndex][0],
        userArr[slideIndex][1],
        userArr[slideIndex][2],
        userArr[slideIndex][3]
      );

      slideIndex++;
      if (slideIndex >= userArr.length) {
        slideIndex = 0;
      }
  ...
  return (
    <div
      id="main"
      style={{
        backgroundImage: `url(/images/${circleData.backgroundImage})`,
      ...
      <div className="circle-box">
        ...
        >
          <div className="user">
            ...
            <a
              href="https://www.linkedin.com/in/sourabh-singh-a77547190/"
              target="_blank"
            >
          ...
          <div className="user">
            <img
              className="user-img"
              src="https://avatars0.githubusercontent.com/u/33419668?s=400&u=1b145a27955d29ddffe512b53b2d71e388cd16b5&v=4"
              alt=""
            />
            ...
            <a
              href="https://www.linkedin.com/in/pratham-agarwal/"
              target="_blank"
            >
              <img className="social-images" src={img2} alt="" />
            </a>
            <a
              href="https://www.instagram.com/_prathampurush_/"
              target="_blank"
            >
              <img className="social-images" src={img3} />
            </a>
          ...
          <div className="user">
            <img
              className="user-img"
              src="https://media-exp1.licdn.com/dms/image/C5603AQGyLr7Kg__oWg/profile-displayphoto-shrink_800_800/0?e=1611792000&v=beta&t=-WpdJS6smSB0IJWbeOssIxQHim0dpNqycSwIeq7UWus"
              alt=""
            />
            <h1>Nipun Singla</h1>
            ...
            <a
              href="https://www.linkedin.com/in/nipun-singla-834946170/"
              target="_blank"
            >
              <img className="social-images" src={img2} alt="" />
            </a>
          ...
          <div className="user">
            <img
              className="user-img"
              src="https://avatars1.githubusercontent.com/u/44068102?s=460&u=5837ef36f0ca48a3dabaf54fc1b4057051fc8f3b&v=4"
              alt=""
            />
            <h1>Saran</h1>
