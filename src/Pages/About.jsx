...
const About = () => {
    ...
    <div className="about-div">
        ...
        <Carousel.Item>
          <img
            className="d-block w-85 aboutimg" alt=""
            src={CR1}
            />
        </Carousel.Item>
        <Carousel.Item>
            ...
            <Card bg={"dark"} text={"white"} className="mb-2">
                ...
                <Card.Body>
                 <Card.Title>Design  </Card.Title>
                  <Card.Text>
                     Build-em-all , E-modeling ,junkyard wards , Micro controller challenge, Roller coaster, Town planning
                 </Card.Text>
                </Card.Body>
            </Card>
            </Col>
            ...
            <Card.Header>
                ...
                <Card.Body>
                 <Card.Title> Managerial </Card.Title>
                  <Card.Text>
                  Apprentice, crescendo, Big fight
                 </Card.Text>
                </Card.Body>
            </Card>
            ...
            <Card.Header>
                ...
                <Card.Body>
                 <Card.Title> Funzone </Card.Title>
                  <Card.Text>
                  Black Box, Game Station, Mr & Miss NITK
                 </Card.Text>
                </Card.Body>
            </Card>
